...
impl Frog {
    pub fn new() -> Self {
        ...
        debug!(target: "Frog::run()", "A new Frog has been created");
        Default::default()
    }
    pub fn hop(&mut self) {
        self.energy -= 1;
        ...
        if self.energy == 0 {
            ...
            warn!(target: "Frog::hop()", "The frog has run out of energy and will go to sleep now");
            self.sleep();
        }
    }
...
impl Default for Frog {
    fn default() -> Self {
        ...
        trace!(target: "Frog::default()", "A default frog value was created: {:?}", frog);
        frog
    }
}
